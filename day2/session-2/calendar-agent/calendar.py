...
class Calendar:
    ...
    def add_event(self, event: Event) -> Event:
        """Add an event to the calendar. Returns the event if added, None if conflict."""
        # Check for conflicts
    ...
    def has_conflict(self, new_event: Event) -> bool:
        ...
        for existing_event in self.events.values():
            ...
            if existing_event.status in [EventStatus.BOOKED, EventStatus.CONFIRMED, EventStatus.ACCEPTED]:
