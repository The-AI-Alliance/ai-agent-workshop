"""MCP tools and resources for Calendar Agent."""
import json
import sys
import traceback
...
from calendar_api import Calendar, EventStatus
...
def register_tools(
    ...
    """Register all MCP tools and resources with the FastMCP instance.
    
    Args:
        mcp: FastMCP instance to register tools with
        df: DataFrame containing agent card embeddings
        calendar: Calendar instance for calendar operations
        db_adapter: CalendarDBAdapter for database operations
    """
